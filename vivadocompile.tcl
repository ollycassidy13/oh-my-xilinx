...
if {[string equal [get_runs -quiet synth_1] ""]} {
  create_run -name synth_1 -part $fpga_part -flow {Vivado Synthesis 2015} -strategy "Vivado Synthesis Defaults" -constrset constrs_1 -mode out_of_context
} else {
...
set util_bram [llength [get_cells -hier -filter {PRIMITIVE_TYPE =~ *BMEM.bram.RAMB*}]]
